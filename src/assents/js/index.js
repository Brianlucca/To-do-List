...
const criarTagLi = (tarefa) => {
  ...
  span.innerHTML = ' <input type="checkbox" id="meuCheckbox" name="meuCheckbox" value="aceito">'+ tarefa.nome
...
const editar = idTarefa => alert(idTarefa)
const excluir = idTarefa => alert(idTarefa)
